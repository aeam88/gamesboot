...
const popular_games = `games?dates=${lastYear},${currentDate}&ordering=-rating&page_size=4`;
...
export const gameScreensShotsURL = (game_id) => `${base_url}games/${game_id}/screenshots`;
